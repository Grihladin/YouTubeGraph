...
def main():
    ...
    # Initialize grouper
    print("🚀 Initializing SegmentGrouper...\n")
    grouper = SegmentGrouper(
        # Use default hyperparameters - tune later if needed
        k_neighbors=8,
            ...
            try:
                ...
                if groups:
                    ...
                    for i, group in enumerate(groups[:3]):
                        print(f"\n  Group {i}:")
                        print(f"    Time: {group.start_time:.1f}s → {group.end_time:.1f}s ({group.end_time - group.start_time:.1f}s)")
